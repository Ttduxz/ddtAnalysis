...
public class blowfish_twokey {
	...
	String P[] = { "243f6a88", "85a308d3", "13198a2e", "03707344", "a4093822",
				...
				"6a267e96", "ba7c9045", "f12c7f99", "24a19947", "b3916cf7",
				"0801f2e2", "858efc16", "636920d8", "71574e69", "a458fea3",
				"f4933d7e", "0d95748f", "728eb658",};

	String E[] = { "b7e15162", "8aed2a6a", "bf715880", "9cf4f3c7", "62e7160f", 
				"38b4da56", "a784d904", "5190cfef", "324e7738", "926cfbe5", 
				"f4bf8d8d", "8c31d763", "da06c80a", "bb1185eb", "4f7c7b57", 
				"57f59584", "90cfd47d", "7c19bb42", 
			
				"158d9554", "f7b46bce", "d55c4d79", "fd5f24d6", "613c31c3",
				"839a2ddf", "8a9a276b", "cfbfa1c8", "77c56284", "dab79cd4",
				"c2b3293d", "20e9e5ea", "f02ac60a", "cc93ed87", "4422a52e",
				"cb238fee", "e5ab6add", "835fd1a0", };
	...
	// generate subkeys.
	private void secondKeyGenerate(String key)
	{
		int j = 0;
		for (int i = 0; i < P.length; i++) {
			...
			// xor-ing 32-bit parts of the key
			// with initial subkeys.
			E[i] = xor(E[i], key.substring(j, j + 8));
	...
	blowfish_twokey(String plainText, String key)
	{
		...
		// String plainText = "1000000000000000";
	...
	{
		new blowfish_twokey(args[0], args[1]);
