...
public class blowfish_addP {
	...
	blowfish_addP(String plainText, String key)
	{
		...
		// String plainText = "f000000000000000";
	...
	{
		new blowfish_addP(args[0], args[1]);
	}
}